...
t0 <- Sys.time()
obj <- readRDS("A:/Workbuddy/singlecell/Rversion/04_integration_clustering/exclude/04_CD45_integrated.rds")
...
csv <- read.csv("A:/Workbuddy/singlecell/Rversion/04_integration_clustering/exclude/01_clustering_summary.csv", stringsAsFactors = FALSE)
